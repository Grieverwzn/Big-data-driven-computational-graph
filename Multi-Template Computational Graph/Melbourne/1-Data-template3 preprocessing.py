...
"""
# Description: Template 3 data preprocessing: baseline demand generation
...
link['free_flow_travel_time'] = link['length']/link['free_speed']*60 # hour
...
stadiums_ll = pd.DataFrame([
    {"name": "Melbourne Cricket Ground", "lon":144.98312373885017, "lat":-37.81863186124403,  "capacity":100024, "car_ratio":0.7},
    {"name": "AAMI Park",                 "lon":144.98466869128995, "lat":-37.823106686435935, "capacity":30050,  "car_ratio":0.7},
    {"name": "Rod Laver Arena",           "lon":144.97866054291288, "lat":-37.819920096304315, "capacity":14820,  "car_ratio":0.7},
    {"name": "Margaret Court Arena",      "lon":144.97797389738406, "lat":-37.81971669226319,  "capacity":7500,   "car_ratio":0.7},
    {"name": "John Cain Arena",           "lon":144.98235126263023, "lat":-37.82114050878017,  "capacity":10500,  "car_ratio":0.7},
    {"name": "Marvel Stadium",            "lon":144.94748404232723, "lat":-37.81633586001247,  "capacity":56000,  "car_ratio":0.7},
])
...
pois_ll = pd.DataFrame([
    {"name": "Queen Victoria Market", "lon": 144.9569, "lat": -37.8060, "car_ratio": 0.55},
    {"name": "St Kilda Beach",       "lon": 144.9739, "lat": -37.8676, "car_ratio": 0.70},
])
...
link_last.to_csv('data_3/link_last.csv',index=False)

link_last = pd.read_csv('data_3/link_last.csv')
link_last
...
DataFrame(node_unique).to_csv('data_new_3/node_unique.csv',index=False)
...
EVENTS = [
    {"sid": STADIUM_NODE_IDS[0], "t_event": 6, "duration_min": 120, "attend": 100024, "car_ratio": 0.7},  # MCG
    {"sid": STADIUM_NODE_IDS[1], "t_event": 6, "duration_min": 120, "attend": 30050,  "car_ratio": 0.7},  # AAMI Park
    {"sid": STADIUM_NODE_IDS[2], "t_event": 6, "duration_min": 120, "attend": 14820,  "car_ratio": 0.7},  # Rod Laver Arena
    {"sid": STADIUM_NODE_IDS[3], "t_event": 6, "duration_min": 120, "attend": 7500,   "car_ratio": 0.7},  # Margaret Court Arena
    {"sid": STADIUM_NODE_IDS[4], "t_event": 6, "duration_min": 120, "attend": 10500,  "car_ratio": 0.7},  # John Cain Arena
    {"sid": STADIUM_NODE_IDS[5], "t_event": 6, "duration_min": 120, "attend": 56000,  "car_ratio": 0.7},  # Marvel Stadium
]

ATTRACTIONS = [
    {"sid": POI_NODE_IDS[0], "visitors_am": 10300, "car_ratio": 0.55, "col_start": 0, "col_end": T-1},
    {"sid": POI_NODE_IDS[1], "visitors_am":  3300,  "car_ratio": 0.70, "col_start": 0, "col_end": T-1},
]
...
link.to_csv('data_3/link.csv',index=False)
...
node.to_csv('data_3/node.csv', index = False)



OD_pair = DataFrame(OD_pair)
OD_pair.columns = ['o_zone_id', 'd_zone_id']
OD_pair.to_csv('data_3/OD_pair.csv', index = False)
...
DataFrame(demand).to_csv('data_3/demand_6-10.csv', index=False)


flow.to_csv('data_3/link_flow.csv', index = False)
